...
<h1 align="center">Hi , I'm Victor Sanchez <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&width=230&lines=Front+Developer;React+Developer" alt="Typing SVG" /></a>
</p>
...
- :school:I am a software development technologist from SENA Colombia.
- :technologist: I love using software as a solution to every problem.
- :computer:."I design and develop web applications with accessibility and usability practices, optimizing user interaction and meeting modern design standards."
- :student: I am currently learning React js.
- :nerd_face: Always `learning new things`.
- :thinking: I am currently open to a new job opportunity, this is MY CURRICULUM VITAE.
- :boom: You can visit [MY WEBSITE](https://victorsanchez.click).
<br>
